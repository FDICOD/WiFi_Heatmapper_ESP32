...
After selection, the display switches to a 6×8 grid representing the measurement area. At each physical location, the system measures the RSSI value of the selected WiFi network and stores it in memory (Scanning takes about 1-5 seconds, set to 10 seconds for best value).
